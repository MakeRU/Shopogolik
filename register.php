	...
	<form action="register.php" method="post">
		<table>
			...
			<tr>
				...
				<td><input type="text" name="url" size="150"/></td>
			</tr>
			<tr>
				<td>Я не робот (ввести 19082010):</td>
				<td><input type="text" name="robot" size="20"/></td>
			</tr>
			<tr>
				<td></td>
...
else
{
	...
	$robot = (isset($_POST['robot'])) ? mysql_real_escape_string($_POST['robot']) : '';	
	...
	if (!$error)
	{
		...
		print '<h4>Пользователь зарегистрирован!</h4>';
	}
	else
	{
