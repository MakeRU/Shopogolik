...
include "menu.php";	
	...
	print '<td><a href="newordfr.php">Новый заказ France</a></td>';	
	print '<td><a href="changerate.php">Изменить курс</a></td>';
	echo "</tr></table>";
...
<form action="allordfr.php" method="post">
	<table>
		<tr>
			<td>Удалить ордер №</td>
...
/*    $payshop = 15;
	...
	echo $sumord;
*/	
//				ORDER BY `Data` DESC, `id_shop` ASC, `id_user` ASC";
    $st="Заказан";
	$query = "SELECT * 
				FROM `order`
				WHERE `Status` = '{$st}'
