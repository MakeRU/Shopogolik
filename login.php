...
print '<p align="center">ƒл€ пользовани€ сайтом необходимо указать логин и пароль.<br>
		ѕомните, что большие и маленькие буквы в логине и пароле различаютс€.<br>
		Ќе допускайте лишних пробелов, которые часто возникают при копировании.</p>';
